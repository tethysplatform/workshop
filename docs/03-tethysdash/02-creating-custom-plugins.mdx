---
sidebar_label: Creating Custom Plugins
---
...
- Complete [TethysDash: Creating Dashboards](./01-creating-dashboards.md). You should have a dashboard named **GEOGLOWS Demo** that contains a Map of Chinese GEOGLOWS flowlines and a **Base Map** variable input.
...
![Starting dashboard from Part 1](./images/creating-custom-plugins/2.1_dashboard_starting_point.png)
...
![Opening the China Flowlines layer editor](./images/creating-custom-plugins/2.2_edit_layer.png)
...
![Setting the river_id variable input on the comid attribute](./images/creating-custom-plugins/2.3_update_attribute_variable.png)
...
![Editing the new grid item](./images/creating-custom-plugins/2.6_edit_new_grid_item.png)

2. Set the **Visualization Type** to `GeoGLOWS Forecast Plot` (under the **Tutorials** group).
3. Set the plot's properties:
   - **River ID:** `${river_id}`

![Configuring the GeoGLOWS Forecast Plot](./images/creating-custom-plugins/2.6_plot_setup.png)
...
![Configuring the plot's placeholder and background](./images/creating-custom-plugins/2.7_plot_settings.png)
...
![Plot resized and placed below the map](./images/creating-custom-plugins/2.9_plot_resize.png)
...
![Configuring the Custom Popup Modal](./images/creating-custom-plugins/2.5B_setup_modal_popup.png)
...
![Popup layout editor with the GeoGLOWS Forecast Plot configured](./images/creating-custom-plugins/2.6B_setup_popup_layout.png)
...
![Final dashboard with the forecast plot responding to a river click](./images/creating-custom-plugins/2.10_try_it_out.png)
...
![Popup modal showing the GeoGLOWS forecast after clicking a river](./images/creating-custom-plugins/2.10B_try_it_out.png)
