...
![TethysDash landing page](./images/creating-dashboards/1.1_landing_page.png)
...
![Creating a new dashboard](./images/creating-dashboards/1.1_creating_dashboard.png)

4. Double-click the new `GEOGLOWS Demo` dashboard card to open it.

![New dashboard card on the landing page](./images/creating-dashboards/1.1_dashboard_in_landing_page.png)
...
![Edit icon in the dashboard toolbar](./images/creating-dashboards/1.2_edit_icon.png)

2. Find the default grid item and click its three-dot menu.
3. Click **Edit**.

![Editing the default grid item](./images/creating-dashboards/1.2_edit_grid_item.png)

4. In the **Visualization Type** dropdown, type `Map` and select the Map option under the **Default** section.

![Choosing the Map visualization](./images/creating-dashboards/1.2_choose_map.png)

5. Select a Base Map for the map (for example, `World Topo Map`).

![Map with a base map selected](./images/creating-dashboards/1.2_map_with_basemap.png)
...
![Adding the China Flowlines layer](./images/creating-dashboards/1.3_add_layer.png)
...
![Configuring the layer source](./images/creating-dashboards/1.4_layer_source.png)
...
![Configuring attribute aliases and popup fields](./images/creating-dashboards/1.5_layer_attributes.png)
...
![Flowlines layer rendered on the map](./images/creating-dashboards/1.6_layer_on_map.png)
...
![Updated map extent zoomed to China](./images/creating-dashboards/1.7_updated_map_extent.png)
...
![Map grid item resized to fill the dashboard](./images/creating-dashboards/1.8_map_on_dashboard.png)

### Step 9 — Save the dashboard

Click the **Save** (disk) icon in the dashboard toolbar to persist everything you have done so far.

![Saving the dashboard](./images/creating-dashboards/1.9_save_dashboard.png)
...
![Opening the dashboard settings pane](./images/creating-dashboards/1.10_dashboard_settings_icon.png)
...
![Enabling unrestricted grid item placement](./images/creating-dashboards/1.10_save_unrestricted_grid_item_placement.png)
...
![Adding a new dashboard item](./images/creating-dashboards/1.12_add_dashboard_item.png)

2. Find the new grid item and click its three-dot menu.
3. Click **Edit**.

![Editing the new grid item](./images/creating-dashboards/1.12_edit_new_item.png)
...
![Configuring the Base Map variable input](./images/creating-dashboards/1.12_variable_input_setup.png)
...
![Variable input resized and placed on the dashboard](./images/creating-dashboards/1.12_variable_input_resized.png)
...
![Editing the map grid item again](./images/creating-dashboards/1.13_edit_map.png)
...
![Binding the map's Base Map to the variable input](./images/creating-dashboards/1.14_connect_variable_input.png)
...
![Final dashboard with the base map switched and a popup open](./images/creating-dashboards/1.17_explore.png)
