...
- Complete [TethysDash: Creating Dashboards](./03-tethysdash-creating-dashboards.md). You should have a dashboard named **GEOGLOWS Demo** that contains a Map of Chinese GEOGLOWS flowlines and a **Base Map** variable input.
...
Your prompt should now start with `(tethys)`. Install TethysDash from PyPI and run the one-time setup command:
...
Then clone the [tethysdash_examples](https://github.com/FIRO-Tethys/tethysdash_examples) repository and install it in development mode so the **GeoGLOWS Forecast Plot** visualization is available in your local TethysDash:

```bash
git clone https://github.com/FIRO-Tethys/tethysdash_examples.git
cd tethysdash_examples
pip install -e .
cd ..
```

Finally, start the local TethysDash development server:

```bash
tethysdash start
```

A browser tab should open automatically. If it does not, you can access TethysDash at [http://127.0.0.1:8000/apps/tethysdash/](http://127.0.0.1:8000/apps/tethysdash/). Log in with the default credentials:
...
![Starting dashboard from Part 1](./images/tethysdash-creating-custom-plugins/2.1_dashboard_starting_point.png)
...
![Opening the China Flowlines layer editor](./images/tethysdash-creating-custom-plugins/2.2_edit_layer.png)
...
![Setting the river_id variable input on the comid attribute](./images/tethysdash-creating-custom-plugins/2.3_update_attribute_variable.png)
...
![Editing the new grid item](./images/tethysdash-creating-custom-plugins/2.6_edit_new_grid_item.png)

2. Set the **Visualization Type** to `GeoGLOWS Forecast Plot` (under the **Tutorials** group).
3. Set the plot's properties:
   - **River ID:** `${river_id}`

![Configuring the GeoGLOWS Forecast Plot](./images/tethysdash-creating-custom-plugins/2.6_plot_setup.png)
...
![Configuring the plot's placeholder and background](./images/tethysdash-creating-custom-plugins/2.7_plot_settings.png)
...
![Plot resized and placed below the map](./images/tethysdash-creating-custom-plugins/2.9_plot_resize.png)
...
![Configuring the Custom Popup Modal](./images/tethysdash-creating-custom-plugins/2.5B_setup_modal_popup.png)
...
![Popup layout editor with the GeoGLOWS Forecast Plot configured](./images/tethysdash-creating-custom-plugins/2.6B_setup_popup_layout.png)
...
![Final dashboard with the forecast plot responding to a river click](./images/tethysdash-creating-custom-plugins/2.10_try_it_out.png)
...
![Popup modal showing the GeoGLOWS forecast after clicking a river](./images/tethysdash-creating-custom-plugins/2.10B_try_it_out.png)
